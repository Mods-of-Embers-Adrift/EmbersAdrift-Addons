...
namespace SoL.UI
{
	...
	public class SelectOneDialog : BaseDialog<SelectOneOptions>
	{
		...
		// Token: 0x06001748 RID: 5960 RVA: 0x0010215C File Offset: 0x0010035C
		private void Update()
		{
			if (!base.Visible)
			{
		...
		// Token: 0x06001749 RID: 5961 RVA: 0x001021B8 File Offset: 0x001003B8
		...
		// Token: 0x0600174A RID: 5962 RVA: 0x00102218 File Offset: 0x00100418
		...
		// Token: 0x0600174B RID: 5963 RVA: 0x001022A4 File Offset: 0x001004A4
