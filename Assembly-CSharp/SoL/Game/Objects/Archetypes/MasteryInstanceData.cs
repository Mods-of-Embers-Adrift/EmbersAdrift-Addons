...
namespace SoL.Game.Objects.Archetypes
{
	...
	public class MasteryInstanceData : INetworkSerializable
	{
		...
		// (add) Token: 0x060055BB RID: 21947 RVA: 0x001DF778 File Offset: 0x001DD978
		// (remove) Token: 0x060055BC RID: 21948 RVA: 0x001DF7B0 File Offset: 0x001DD9B0
		public event Action MasteryDataChanged;

		// Token: 0x14000113 RID: 275
		// (add) Token: 0x060055BD RID: 21949 RVA: 0x001DF7E8 File Offset: 0x001DD9E8
		// (remove) Token: 0x060055BE RID: 21950 RVA: 0x001DF820 File Offset: 0x001DDA20
		public event Action<UniqueId> SpecializationUnlearned;

		// Token: 0x14000114 RID: 276
		// (add) Token: 0x060055BF RID: 21951 RVA: 0x001DF858 File Offset: 0x001DDA58
		// (remove) Token: 0x060055C0 RID: 21952 RVA: 0x001DF890 File Offset: 0x001DDA90
		public event Action LevelDataChanged;

		// Token: 0x170013DC RID: 5084
		// (get) Token: 0x060055C1 RID: 21953 RVA: 0x00079338 File Offset: 0x00077538
		// (set) Token: 0x060055C2 RID: 21954 RVA: 0x001DF8C8 File Offset: 0x001DDAC8
		[BsonIgnoreIfNull]
