...
namespace SoL.Game.Culling
{
	...
	public class CulledLight : CulledObject
	{
		...
		// Token: 0x060062B3 RID: 25267 RVA: 0x002055E4 File Offset: 0x002037E4
		private void Awake()
		{
		...
		// Token: 0x060062B4 RID: 25268 RVA: 0x002056EC File Offset: 0x002038EC
		...
		// Token: 0x060062B6 RID: 25270 RVA: 0x00205754 File Offset: 0x00203954
		private void Update()
		{
			if (!this.m_light)
			{
		...
		{
			// Token: 0x060062C0 RID: 25280 RVA: 0x0020597C File Offset: 0x00203B7C
