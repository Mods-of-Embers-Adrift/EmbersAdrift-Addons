...
namespace SoL.UI
{
	...
	public class TeleportButtonPanel : MonoBehaviour
	{
		...
		// (add) Token: 0x06001840 RID: 6208 RVA: 0x00103B40 File Offset: 0x00101D40
		// (remove) Token: 0x06001841 RID: 6209 RVA: 0x00103B78 File Offset: 0x00101D78
		public event Action TravelClicked;

		// Token: 0x14000027 RID: 39
		// (add) Token: 0x06001842 RID: 6210 RVA: 0x00103BB0 File Offset: 0x00101DB0
		// (remove) Token: 0x06001843 RID: 6211 RVA: 0x00103BE8 File Offset: 0x00101DE8
		public event Action EssenceClicked;

		// Token: 0x14000028 RID: 40
		// (add) Token: 0x06001844 RID: 6212 RVA: 0x00103C20 File Offset: 0x00101E20
		// (remove) Token: 0x06001845 RID: 6213 RVA: 0x00103C58 File Offset: 0x00101E58
		public event Action CancelClicked;

		// Token: 0x06001846 RID: 6214 RVA: 0x00103C90 File Offset: 0x00101E90
		private void Awake()
		{
		...
		// Token: 0x06001847 RID: 6215 RVA: 0x00103D18 File Offset: 0x00101F18
		...
		// Token: 0x0600184B RID: 6219 RVA: 0x00103DA0 File Offset: 0x00101FA0
