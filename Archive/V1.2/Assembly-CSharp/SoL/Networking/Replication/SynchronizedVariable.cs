...
namespace SoL.Networking.Replication
{
	...
	public abstract class SynchronizedVariable<T> : ISynchronizedVariable
	{
		...
		// (add) Token: 0x060020C0 RID: 8384 RVA: 0x001225F8 File Offset: 0x001207F8
		// (remove) Token: 0x060020C1 RID: 8385 RVA: 0x00122630 File Offset: 0x00120830
		...
		// (set) Token: 0x060020C5 RID: 8389 RVA: 0x00122668 File Offset: 0x00120868
		public T Value
		{
			get
			{
		...
		// Token: 0x060020D5 RID: 8405 RVA: 0x001226C4 File Offset: 0x001208C4
