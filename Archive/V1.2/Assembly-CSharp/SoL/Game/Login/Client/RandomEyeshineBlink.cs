...
namespace SoL.Game.Login.Client
{
	...
	public class RandomEyeshineBlink : MonoBehaviour
	{
		...
		// (add) Token: 0x06005858 RID: 22616 RVA: 0x001E5AF8 File Offset: 0x001E3CF8
		// (remove) Token: 0x06005859 RID: 22617 RVA: 0x001E5B30 File Offset: 0x001E3D30
		public event Action<RandomEyeshineBlink> StateClosed;

		// Token: 0x0600585A RID: 22618 RVA: 0x001E5B68 File Offset: 0x001E3D68
		private void Awake()
		{
		...
		// Token: 0x0600585C RID: 22620 RVA: 0x001E5BF8 File Offset: 0x001E3DF8
		private void Update()
		{
			if (!this.m_renderer)
			{
