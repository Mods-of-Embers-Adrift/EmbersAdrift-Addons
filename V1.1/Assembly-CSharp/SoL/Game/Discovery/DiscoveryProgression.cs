...
namespace SoL.Game.Discovery
{
	...
	public static class DiscoveryProgression
	{
		...
		// (add) Token: 0x06006229 RID: 25129 RVA: 0x0020399C File Offset: 0x00201B9C
		// (remove) Token: 0x0600622A RID: 25130 RVA: 0x002039D0 File Offset: 0x00201BD0
		public static event Action<DiscoveryProfile> DiscoveryFound;

		// Token: 0x14000123 RID: 291
		// (add) Token: 0x0600622B RID: 25131 RVA: 0x00203A04 File Offset: 0x00201C04
		// (remove) Token: 0x0600622C RID: 25132 RVA: 0x00203A38 File Offset: 0x00201C38
		public static event Action DiscoveryRefresh;

		// Token: 0x0600622D RID: 25133 RVA: 0x00203A6C File Offset: 0x00201C6C
		...
		// Token: 0x0600622E RID: 25134 RVA: 0x00203A98 File Offset: 0x00201C98
